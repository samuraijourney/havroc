...
linker.cmd: package/cfg/empty_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem4fcfg.cmd\)\"$""\"H:/Users/Akram/Programs/GitHub/havroc/projects/tiva_tm4c123gh6pm/.config/xconfig_empty/\1\""' package/cfg/empty_pem4f.xdl > $@
